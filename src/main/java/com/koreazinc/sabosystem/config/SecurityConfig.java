...
import com.koreazinc.sabosystem.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/swagger-ui/**", "/v3/api-docs/**", "/uploads/**",
                                "/api/banners/active", "/api/popups/active", "/api/social/**")
                        .permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
                ...
                "https://kz-magazine-backend.jp.ngrok.io" // Add backend too just in case
        ));
